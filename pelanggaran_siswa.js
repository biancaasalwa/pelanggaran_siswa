...
//transaksiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
...
router.post("/pelanggaran_siswa", (req, res)=>{
    ...
    let data = {
        ...
        waktu: moment(). format('YYYY-MM-DD HH:mm:ss')// get curent time
    }

    //parse to JSON
    let pelanggaran = JSON.parse(req.body.pelanggaran)

    //create query insert to pelanggaran siswa
...
//end-point menampilkan data pelanggran_siswa
...
router.get("/pelanggaran_siswa/:id_pelanggaran_siswa", (req, res)=>{
    ...
    //create sql query
    let sql = "select p.nama_pelanggaran, p.join " +
...
//end-point untuk menghapus data pelanggaran siswa
router.delete("/pelanggaran_siswa/:id_pelanggaran_siswa", (req, res) => {
    let param = { id_pelanggaran_siswa: req.params.id_pelanggaran_siswa}

    //create sql delete detail pelanggaran
    ...
    db.query(sql, param, (error, result) => {
        if(error){
            ...
            //create sql query delete pelanggaran siswa
